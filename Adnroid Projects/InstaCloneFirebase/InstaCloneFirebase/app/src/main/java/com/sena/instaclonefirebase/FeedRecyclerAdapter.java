...
public class FeedRecyclerAdapter extends RecyclerView.Adapter<FeedRecyclerAdapter.PostHolder> {
    ...
    public PostHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        //bizim oluşturduğumuz xml ile bağlama işlevi burada yapılacak (recyler_row xmlile)
    ...
    public void onBindViewHolder(@NonNull PostHolder holder, int position) {
        ...
        //görselleri indirmek için picasso kütüphanesi sizin için url yi indiriyor ve imageviewda gösteriyor
    ...
    class PostHolder extends RecyclerView.ViewHolder {
        //görünümleri burada tanımla recycler viewdaki
        ImageView imageView;
        TextView userEmailText;
        TextView commentText;
        public PostHolder(@NonNull View itemView) {
            super(itemView);
            imageView = itemView.findViewById(R.id.recyclerciew_row_imageview);
